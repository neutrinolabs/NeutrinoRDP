...
typedef void (*pBitmap_Decompress)(rdpContext* context, rdpBitmap* bitmap,
		...
		tbool compressed, int codec_id);
typedef void (*pBitmap_SetSurface)(rdpContext* context, rdpBitmap* bitmap, tbool primary);
...
FREERDP_API void Bitmap_SetSurface(rdpContext* context, rdpBitmap* bitmap, tbool primary);
